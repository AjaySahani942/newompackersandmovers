...
// import img20 from "../images/Newsletter.webp";
function NewsLetter() {
    return (
        <div className="xl:flex xl:justify-end pt-[3rem]">
            <div className="container sm:mx-auto">
                <div className="block xl:flex justify-between xl:items-center lg:items-center md:flex">
                    <div className="w-11/12 xl:w-4/12 mx-auto xl:mx-0 md:w-5/12">
                        <h1 className="text-gray-800 text-3xl font-extrabold mb-3 pt-[1rem] xl:pt-0">Sign Up for Our Services</h1>
                        ...
                        <div className="flex w-full flex-wrap">
                            <div className="w-full">
                                <div className="flex flex-col mb-3">
                                    ...
                                    <input type="email" id="email" placeholder="newompackersandmovers787@gmail.com" className="focus:outline-none focus:border-[#00838C] border-gray-300 border rounded-sm py-2 outline-none pl-2 pr-2" />
                                </div>
                                <button type="submit" className="focus:outline-none bg-[#00838C] hover:bg-[#00838cce] text-white text-base w-full py-3 px-6 rounded">
                                    Subscribe to NewOm Packers & Movers
                                </button>
                            </div>  
                        </div>
                    </div>
                    <div className="w-11/12 xl:w-5/12 mx-auto xl:mx-0 mt-8 xl:mt-0 flex justify-end md:w-5/12 bg-[#00838c33] relative py-20 rounded-lg">
                        <div className="h-4/5 w-4/5 ">
                            <img src='/images/Newsletter.webp' alt='Newsletter' className="h-full w-full overflow-hidden object-cover relative z-10 xl:-ml-56 lg:-ml-32 sm:-ml-20 -ml-12 md:-ml-20 rounded-lg" />
                        </div>
                        {/* Svg Code */}
